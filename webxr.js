...
window.addEventListener('DOMContentLoaded', () => {
  ...
  async function startAR() {
    try {
      ...
      // Try different reference spaces based on platform
      const referenceSpaceTypes = isIOS ? ['viewer'] : ['local', 'local-floor', 'viewer'];
  ...
  function initARFeatures() {
    ...
    // Hit test source
    if (xrSession.enabledFeatures && xrSession.enabledFeatures.includes('hit-test')) {
